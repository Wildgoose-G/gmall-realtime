...
//        System.setProperty("HADOOP_USER_NAME", PropertiesUtil.get("application.username"));
        ...
        tableEnv.executeSql(KafkaUtil.getTopicDb("dwd_trade_refund_pay_suc"));

        // TODO 3.建立 MySQL-LookUp 字典表
        tableEnv.executeSql(MysqlUtil.getBaseDicLookUpDDL());

        // TODO 4. 读取退款表数据，并筛选退款成功数据
...
//                        "and `old`['refund_status'] is not null"
        ...
        // TODO 8.创建 Kafka-Connector dwd_trade_refund_pay_suc 表
...
//                "insert into dwd_trade_refund_pay_suc select * from result_table");
        ...
        tableEnv.sqlQuery("select * from dwd_trade_refund_pay_suc").execute().print();
    }
}
